...
void Attacker::_bind_methods() {
    ...
    ClassDB::bind_method(D_METHOD("get_glide_gravity"), &Attacker::get_glide_gravity);
    ClassDB::bind_method(D_METHOD("set_glide_gravity", "glide gravity"), &Attacker::set_glide_gravity);
    ClassDB::add_property("Attacker", PropertyInfo(Variant::FLOAT, "glide gravity", PROPERTY_HINT_RANGE, 
    ...
    ClassDB::bind_method(D_METHOD("get_lives"), &Attacker::get_lives);
...
void Attacker::initialize_sound() {
...
void Attacker::play_empty_interact() {
...
void Attacker::food_interaction(bool entered) {
    if (entered && Input::get_singleton()->is_action_just_pressed("E")) {
...
void Attacker::set_glide_gravity(float p_glide_gravity) {
    glide_gravity = p_glide_gravity;
}

float Attacker::get_glide_gravity() {
...
bool Attacker::get_ad_rotate() {
    return AD_rotate;
}

int Attacker::get_lives() {
    return lives;
}

bool Attacker::get_sound_toggle() {
    return mute_sound_effects;
}

void Attacker::set_lives(int p_lives) {
    lives = p_lives;
}

void Attacker::toggles() {
